...
{
    public class EnemySpawnerDefault : IEnemySpawner
    {
        private const float BossHealthMultiplier = 0.2f;
        private const int BossDamageModifier = 1;
